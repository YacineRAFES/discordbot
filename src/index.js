...
const { Client, IntentsBitField, EmbedBuilder, AttachmentBuilder, ActivityType, Partials } = require('discord.js');
...
//Répond en utilisant les réactions
    ...
    if(interaction.commandName === 'meteo2'){
        ...
        .then(response => {
            ...
            .addFields(
                ...
                { name: 'Ressenti', value: `${ressenti} °C` },
            )
            .setTimestamp()
